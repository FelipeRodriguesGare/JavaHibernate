...
public class EmprestimoService {
    ...
    public void buscaPessoa() {
        Pessoa pessoa = pessoaRepository.findById(2).orElseThrow(() -> new RuntimeException("Pessoa nao existe"));
...
//        pessoas = pessoaRepository.findByNome("Eduardo");
        ...
        pessoas = pessoaRepository.findByNomeEndsWith("ardo");
        pessoas.forEach(p -> System.out.println(p.getId() + " " + p.getNome()));
...
//        List<Emprestimo> emprestimos = emprestimoRepository.findByValorGreaterThan(5000F);
...
//        LocalDateTime data = LocalDateTime.of(2022, 03, 23, 0, 0, 0);
//
...
//        emprestimos.forEach(e -> System.out.println(e.getId()));
    ...
    public void groupBy() {
        ...
        List<Object[]> medias = pessoaRepository.getMediaSalarioObject();
